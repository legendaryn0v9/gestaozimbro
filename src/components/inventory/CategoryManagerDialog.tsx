...
const ICON_OPTIONS = [
  ...
  { value: 'GlassWater', label: 'Água' },
  { value: 'UtensilsCrossed', label: 'Talheres' },
...
export function CategoryManagerDialog({ open, onOpenChange, sector }: CategoryManagerDialogProps) {
  ...
  const [newCategoryIcon, setNewCategoryIcon] = useState(ICON_OPTIONS[0].value);
  ...
  const handleCreateCategory = async () => {
    ...
    setNewCategoryIcon(ICON_OPTIONS[0].value);
  };
